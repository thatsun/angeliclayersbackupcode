...
public class C_dialogos_finalbosses : MonoBehaviour {
	...
	void Start () {
        ...
        if(game_control.control.nivel_actual==0){
            game_control.control.catalogo_misiones[0].cleared = 1;
            game_control.control.catalogo_misiones[1].unlocked = 1;

        }
        if(game_control.control.nivel_actual==1){
            game_control.control.catalogo_misiones[1].cleared = 1;
            game_control.control.catalogo_misiones[2].unlocked = 1;

            

        }
        if(game_control.control.nivel_actual==2){
            game_control.control.catalogo_misiones[2].cleared = 1;
            game_control.control.catalogo_misiones[3].unlocked = 1;

            if (game_control.control.armorunlocked==0)
            {
                game_control.control.armorunlocked = 1;
            }
            
        }
		if(game_control.control.nivel_actual==3){
            game_control.control.catalogo_misiones[3].cleared = 1;
            game_control.control.catalogo_misiones[4].unlocked = 1;
            if (game_control.control.armorunlocked ==1)
            {
                game_control.control.armorunlocked = 2;
            }
        }
        if(game_control.control.nivel_actual==4){
            game_control.control.catalogo_misiones[4].cleared = 1;
            game_control.control.catalogo_misiones[5].unlocked = 1;
            if (game_control.control.espunlocked ==0 )
            {
                game_control.control.espunlocked = 1;
            }

        }
        if(game_control.control.nivel_actual==5){
            game_control.control.catalogo_misiones[5].cleared = 1;
            game_control.control.catalogo_misiones[6].unlocked = 1;
            if (game_control.control.armorunlocked == 2)
            {
                game_control.control.armorunlocked = 3;
            }
        }
		if(game_control.control.nivel_actual==6){
            game_control.control.catalogo_misiones[6].cleared = 1;
            game_control.control.catalogo_misiones[7].unlocked = 1;

            if (game_control.control.espunlocked ==1)
            {
                game_control.control.espunlocked = 2;
            }
        }
		
		if(game_control.control.nivel_actual==8){
